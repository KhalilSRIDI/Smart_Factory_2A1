...
personnels::personnels(QString c,QString n,QString p,QString nT,QString s,QString eC,QDate dN,QString gO,QString gH,QString dE,QDate dR,QString tC,QString dep ,QString u,QString f,int slr)
{
    cin = c;
    nom = n;
    prenom = p;
...
{
    QSqlQuery qry;
    qry.prepare("INSERT INTO PERSONNELS (CIN, NOM, PRENOM,NUMERO_TEL,SEXE,ETAT_CIVILE,DIPLOME_ETUDE,TYPE_CONTRAT,GOUVERNORAT_ORIGIN,GOUVERNORAT_HABITATION,UNITE,FONCTION,SALAIRE,DEPARTEMENT,DATE_NAISSANCE,DATE_RECRUTEMENT)"
                "VALUES (:CIN, :NOM, :PRENOM,:NUMERO_TEL,:SEXE,:ETAT_CIVILE,:DIPLOME_ETUDE,:TYPE_CONTRAT,:GOUVERNORAT_ORIGIN,:GOUVERNORAT_HABITATION,:UNITE,:FONCTION,:SALAIRE,:DEPARTEMENT,:DATE_NAISSANCE,:DATE_RECRUTEMENT)");
